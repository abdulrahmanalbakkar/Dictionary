...
class RecyclerViewMainAdapter(private val WordsList: ArrayList<Word>): RecyclerView.Adapter<RecyclerViewMainAdapter.RecyclerViewMainViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerViewMainViewHolder {
        ...
        return RecyclerViewMainViewHolder(itemView)
    }
    ...
    override fun onBindViewHolder(holder: RecyclerViewMainViewHolder, position: Int) {
        ...
        holder.tv2.visibility = if(isExpandable) View.VISIBLE else View.GONE
        holder.tv3.visibility = if(isExpandable) View.VISIBLE else View.GONE
        holder.tv4.visibility = if(isExpandable) View.VISIBLE else View.GONE
        holder.favBtn.visibility = if(isExpandable) View.VISIBLE else View.GONE
    ...
    class RecyclerViewMainViewHolder(itemView: View): RecyclerView.ViewHolder(itemView)/*, View.OnCreateContextMenuListener*/{
